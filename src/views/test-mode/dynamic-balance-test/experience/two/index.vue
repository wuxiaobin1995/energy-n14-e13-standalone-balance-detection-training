<!--
 * @Author      : Mr.bin
 * @Date        : 2021-12-30 09:13:36
 * @LastEditTime: 2022-07-26 15:01:07
 * @Description : 动态平衡测试-测前体验2
-->
<template>
  <div class="dynamic-balance-test-experience-two">
    <!-- 倒计时 -->
...
export default {
  ...
  methods: {
    ...
    handleToMeasure() {
      this.$router.push({
        path: '/layout/dynamic-balance-test-measure-two',
        query: {
...
.dynamic-balance-test-experience-two {
  width: 100%;
  height: 100%;
