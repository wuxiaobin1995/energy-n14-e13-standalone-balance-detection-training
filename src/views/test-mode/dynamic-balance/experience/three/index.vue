<!--
 * @Author      : Mr.bin
 * @Date        : 2021-12-30 09:13:59
 * @LastEditTime: 2022-07-26 15:00:52
 * @Description : 动态平衡测试-测前体验3
-->
<template>
  <div class="dynamic-balance-test-experience-three">
    <!-- 倒计时 -->
...
export default {
  ...
  methods: {
    ...
    handleToMeasure() {
      this.$router.push({
        path: '/layout/dynamic-balance-test-measure-three',
        query: {
...
.dynamic-balance-test-experience-three {
  width: 100%;
  height: 100%;
