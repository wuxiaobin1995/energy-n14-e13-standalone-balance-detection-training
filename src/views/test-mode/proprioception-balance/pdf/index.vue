 ...
 * @Description : 本体感觉平衡测试-PDF报告
-->
<template>
  <div
    class="test-proprioception-balance-pdf"
  ...
  >
    ...
    <div id="pdf" class="pdf-wrapper">
      ...
      <div class="top">
        <div class="title">
          本体感觉平衡测试报告({{ pdfData.hospital ? pdfData.hospital : '' }})
        </div>
        <div class="logo">
...
export default {
  ...
  methods: {
    ...
    handlePrint() {
      this.$htmlToPdf(
        'pdf',
        `本体感觉平衡测试报告 ${this.$moment().format('YYYY-MM-DD HH_mm_ss')}`,
        420
      )
    },
...
.test-proprioception-balance-pdf {
  width: 100%;
  height: 100%;
