 ...
 * @LastEditTime: 2023-04-12 17:04:12
 * @Description : 前后平衡测试-具体测量
-->
<template>
  <div class="test-fb-balance-measure">
    <div class="wrapper">
      <!-- 标题 -->
...
export default {
  ...
  methods: {
    ...
    handleCheckPdf() {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-select/fb-balance-set')
        }
      })
    },
    ...
    handleGoBack() {
      this.$router.push({
        path: '/test-select/fb-balance-set'
      })
    },
