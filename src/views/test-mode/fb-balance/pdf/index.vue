 ...
 * @LastEditTime: 2023-04-12 17:10:29
 * @Description : 前后平衡测试-PDF报告
-->
<template>
  <div
    class="test-fb-balance-pdf"
  ...
  >
    ...
    <div id="pdf" class="pdf-wrapper">
      ...
      <div class="top">
        <div class="title">
          前后平衡测试报告({{ pdfData.hospital ? pdfData.hospital : '' }})
        </div>
        <div class="logo">
...
export default {
  ...
  methods: {
    ...
    handlePrint() {
      this.$htmlToPdf(
        'pdf',
        `前后平衡测试报告 ${this.$moment().format('YYYY-MM-DD HH_mm_ss')}`,
        420
      )
    },
