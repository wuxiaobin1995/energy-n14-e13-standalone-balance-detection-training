 ...
 * @LastEditTime: 2023-04-14 09:18:13
 * @Description : 前后平衡测试-参数设置
-->
<template>
  <div class="fb-balance-set">
    <!-- 语音播放 -->
    ...
    <!-- 提示 -->
    <div class="tip">
      提示语：请双腿平稳站立在平台上，测试前后重心动态转移的平衡能力。
    </div>
...
export default {
  ...
  data() {
    return {
      sketchMapSrc: require('@/assets/img/Test/FB_Balance/show.png'), // 示意图

      /* 语音相关 */
      audioOpen: this.$store.state.voiceSwitch,
      audioSrc: path.join(__static, `narrate/mandarin/前后平衡测试.mp3`),
