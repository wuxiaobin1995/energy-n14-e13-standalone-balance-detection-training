 ...
 * @LastEditTime: 2023-04-12 17:49:26
 * @Description : 对角线平衡测试-数据记录
-->
<template>
  <div class="diagonal-balance">
    <!-- 顶部 -->
    ...
    handleToPdf(index, row) {
      this.$router.push({
        ...
        query: {
          ...
          routerName: JSON.stringify('/test-record/diagonal-balance')
        }
      })
    },
