 ...
 * @Description : 平衡测试-长期趋势报告
-->
<template>
  <div
    class="test-balance-secular-trend-pdf"
    v-loading.fullscreen.lock="fullscreenLoading"
  >
    <!-- PDF区域 -->
    <div id="pdf" class="pdf-wrapper">
      <div class="up">
        <div class="title">平衡测试-长期趋势报告</div>
        <div class="logo-img">
...
export default {
  ...
  methods: {
    ...
    handlePrint() {
      this.$htmlToPdf(
        'pdf',
        `平衡测试-长期趋势报告 ${this.$moment().format(
          'YYYY-MM-DD HH_mm_ss'
        )}`,
        580
      )
...
.test-balance-secular-trend-pdf {
  width: 100%;
  height: 100%;
